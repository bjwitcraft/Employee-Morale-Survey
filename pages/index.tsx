...
function SurveyInner() {
  ...
  // Loading placeholder until client initializes
          ...
          <>
            {questions.map((q) => (
              <QuestionCard
                ...
                q={q}
                value={answers[q.id]}
                onChange={(v: any) => setAnswers((a) => ({ ...a, [q.id]: v }))}
              />
            ))}
...
// 🚫 Disable SSR for this page to avoid any hydration mismatch
export default dynamic(() => Promise.resolve(SurveyInner), { ssr: false });
