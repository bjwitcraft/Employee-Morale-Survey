...
// 28 questions total as requested
export const QUESTION_BANK: Question[] = [
  ...
  { id: 'os3', cat: 'other_supervisors', type: 'likert', text: 'Handoffs between departments (e.g., Wave Desk ↔ Loading) were smooth.' },
...
export function pickQuestions(seed: number, n = 4): Question[] {
  ...
  const coreCats: Category[] = ['morale','direct_supervisor','other_supervisors','training','senior_leadership','safety'];
